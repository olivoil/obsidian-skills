...
**Reading from Intervals**: Browser automation using a tool that can evaluate page-context JavaScript
...
3. Browser automation configured for the Intervals timesheet tab
